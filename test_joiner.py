...
class TestAqGpsJoiner(unittest.TestCase):
    def test_join(self):
        #aq =  '8530C_2-5_002.csv'
        #print(aq)
        #gps = 'GPS_20140717_193858_8530C.log'
        #print(gps)
        #j2 = AqGpsJoiner(aq, gps, 'testJoinedFile.csv', tdiff_tolerance_secs=1, filter_size='10')
        #j2.createFile()
        ...
        joiner = AqGpsJoiner(aq, gps, 'testJoinedFile.csv', tdiff_tolerance_secs=1, filter_size='10')
